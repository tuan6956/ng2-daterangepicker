ng2-daterangepicker-dayjs
-------------------

![Daterange Picker](https://raw.githubusercontent.com/evansmwendwa/ng2-daterangepicker-dayjs/master/projects/ng2-daterangepicker-dayjs/assets/screen-shot.png)
...
```
npm install ng2-daterangepicker-dayjs
yarn add ng2-daterangepicker-dayjs
ng add ng2-daterangepicker-dayjs
```
...
{
  "styles": [
    "node_modules/ng2-daterangepicker-dayjs/assets/daterangepicker.css"
  ],
  "scripts": [
...
``` javascript
import { Daterangepicker } from 'ng2-daterangepicker-dayjs';
...
``` javascript
import { DaterangepickerConfig } from 'ng2-daterangepicker-dayjs';
...
import { DaterangePickerComponent } from 'ng2-daterangepicker-dayjs';
...
Run `ng build ng2-daterangepicker-dayjs` to build the project. The build artifacts will be stored in the `dist/` directory.

## Publishing

After building your library with `ng build ng2-daterangepicker-dayjs`, go to the dist folder `cd dist/ng2-daterangepicker-dayjs` and run `npm publish`.

## Running unit tests

Run `ng test ng2-daterangepicker-dayjs` to execute the unit tests via [Karma](https://karma-runner.github.io).
